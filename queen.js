...
async function sessdl() {
  try {
    ...
    const base64Data = sess.SESSION_ID.split("DILA-XPRO~")[1];
    if (!base64Data) {
...
async function connectToWA() {
  ...
  //===========================
  console.log("🔥 DILA_MD XPRO is starting...");
  ...
  conn.ev.on("connection.update", (update) => {
    ...
    if (connection === "close") {
      ...
      let up = `
          ...
          --- Thank you for using **© DILA MD 𝗑ᴾᴿᴼ 💚**. 
      ...
      conn.sendMessage(conn.user.id, {
        ...
        contextInfo: {
          ...
          forwardedNewsletterMessageInfo: {
            ...
            newsletterName: "© DILA MD 𝗑ᴾᴿᴼ 💚",
            serverMessageId: 999,
          },
          externalAdReply: {
            title: "© DILA MD 𝗑ᴾᴿᴼ 💚",
            body: " ©𝐌𝐑 DILAKSHA 𝐎𝐅𝐂 💚",
            mediaType: 1,
